...
const FeatureSquare = React.forwardRef((props, ref) => {
    return (
        <div data-scroll-section data-scroll ref={ref} className={'min-h-[93vh] relative px-4  pb-16'}>
            ...
            <div className={'md:grid hidden md:grid-cols-3 lg:gap-16 md:gap-10 gap-6 md:mb-0 mb-10 hidden'}>
                <div className={''}>
                    <div className='rounded-[30px] overflow-hidden bg-[#F2F2F2]'>
                        <img src={props.imgSquare1} className={'object-cover w-2/3 pt-14 mx-auto'} alt=""/>
                    </div>
                ...
                <div className={''}>
                    <div className='rounded-[30px] overflow-hidden bg-[#F2F2F2]'>
                        <img src={props.imgSquare2} className={'object-cover w-2/3 pt-14 mx-auto '} alt=""/>
                    </div>
                    <div className={'text-center mt-6 md:px-10 flex flex-col'}>
                ...
                <div className={''}>
                    <div className='rounded-[30px] overflow-hidden bg-[#F2F2F2]'>
                        <img src={props.imgSquare3} className={'object-cover w-2/3 pt-14 mx-auto '} alt=""/>
                    </div>
                    <div className={'text-center mt-6 md:px-10 flex flex-col'}>
            ...
            <div id="carouselExampleControls" className="carousel slide relative md:hidden block w-3/4 mx-auto"
                 data-bs-ride="carousel">
                <div className="carousel-inner relative w-full overflow-hidden">
                    <div className="carousel-item active relative float-left w-full">
                        <div className={'bg-black/5 pt-8 px-8 !rounded-[30px]'}>
                            <img
                    ...
                    <div className="carousel-item relative float-left w-full">
                        <div className={'bg-black/5 pt-8 !rounded-[30px] px-8'}>
                            <img
                ...
                >
                    <BsChevronLeft color={'black'} size={28}
                                   className="carousel-control-prev-icon inline-block bg-no-repeat absolute top-[150px] right-12"
                                   aria-hidden="true"></BsChevronLeft>
                ...
                >
                    <BsChevronRight color={'black'} size={28}
                                    className="carousel-control-next-icon inline-block bg-no-repeat absolute top-[150px] left-12"
                                    aria-hidden="true"/>
