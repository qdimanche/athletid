...
const TermsContent = () => {
    return (<div className={'2xl:px-32 lg:px-24 px-8 flex flex-col pt-32 pb-16'}>
        <h1 className={'mb-[20px] !whitespace-normal'}>Conditions Générales de vente et d’utilisation de l'application
            Athletid</h1>
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 1 – Définitions</h2>
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 2 – Applicabilité et objet</h2>
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 3 - Caractéristiques des produits
            proposés</h2>
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 4 – Commande et Tarifs</h2>
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 5 - Compte dans l'application</h2>
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 6 - Exonération de la
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 12 - Accès à l'application par
            connexion
            Internet</h2>
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 13 - Fermeture de compte</h2>
        ...
        <h2 className={'!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]'}>Article 14 - Droit applicable et
            médiation</h2>
        ...
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Médiation de la consommation</h2>
        ...
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Article 15 - Utilisation de Cookies et de
            fichiers déposés
        ...
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Article 16 - Garantie des produits achetés
            dans
            l'application</h2>
        <p>Tous les produits acquis sur l’application bénéficient des garanties légales suivantes, prévues par le
            Code Civil.</p>
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Garantie de conformité :</h2>
        ...
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Garantie des vices cachés</h2>
        ...
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Article 17 - Archivage</h2>
        ...
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Article 18 - Encadrement des
            conditions</h2>
        ...
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Article 19 - Notifications</h2>
        ...
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Article 20 - Réclamations</h2>
        <p>Toute réclamation liée à l’utilisation de l’application, des pages de l’application sur des réseaux
            ...
            justice.</p>
        <h2 className={"!whitespace-normal text-[2.2em] mt-[40px] mb-[20px]"}>Article 21 - Inexactitudes</h2>
